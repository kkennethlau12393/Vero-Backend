...
def _build_extraction_prompt(
    ...
    prompt = (
        ...
        "5. 'validation_method': Describe the experimental setup, datasets, baselines compared against, "
        "and statistical methods used (e.g., ANOVA, t-test, confidence intervals). "
        "Do NOT list metric names or values here — those go in 'validation_metrics'. "
        "Focus on: what data was used, how many samples/replicates, what baselines or prior work "
        "results were compared against, and how statistical significance was assessed. "
