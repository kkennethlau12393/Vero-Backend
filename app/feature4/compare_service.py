...
def _build_extraction_prompt(
    ...
    prompt = (
        ...
        "5. 'validation_method': 1-3 sentences ONLY. State the baselines/prior work compared against "
        "and the statistical tests used (e.g., ANOVA, t-test, Tukey HSD, p-value threshold). "
        "Do NOT repeat experimental setup, sample counts, or data details — those belong in "
        "'data_requirements' and 'approach'. Do NOT list metric names or values — those go in "
        "'validation_metrics'. Example: 'Compared against published granite fracture toughness data "
        "(Smith et al., 2020). Statistical significance assessed via one-way ANOVA + Tukey HSD (p < 0.05).' "
